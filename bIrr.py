...
#script for pumping with irrational b
...
nM=1# number of irrational periods
...
plt.xlabel("$n$")
plt.savefig("Irrational_b, nM="+str(nM)+", T1"+str(T1)+"T2"+str(T2)+"betaNum"+str(M)+"blochNum"+str(N)+"displacement.png")
plt.close()
