...
file0=outDir+"dataFrameT1"+str(T1)+"0"+"band"+str(0)+".csv"#+"a"+str(a)+"b"+str(b)+"band"+str(0)+".csv"
file1=outDir+"dataFrameT1"+str(T1)+"0"+"band"+str(1)+".csv"#+"a"+str(a)+"b"+str(b)+"band"+str(1)+".csv"
file2=outDir+"dataFrameT1"+str(T1)+"0"+"band"+str(2)+".csv"#+"a"+str(a)+"b"+str(b)+"band"+str(2)+".csv"
...
plt.yticks([-8,-4,0,4],fontsize=ftSize)
plt.xticks(fontsize=ftSize)
xMax=600
plt.hlines(y=-8, xmin=0, xmax=xMax, linewidth=0.5, color='k',linestyles="--")
